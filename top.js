...
const className2 =document.getElementById('hd2');
...
btn_25.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		import(modulePath1).then((module) => {
			module.ChangerForOnDue(25, id1, btn_05, btn_06, btn_07);
		})
	})
})
...
btn_30.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		const modulePath1 = './modules/ChangerForOnDue.js';
		import(modulePath1).then((module) => {
			module.ChangerForOnDue(30, id1, btn_05, btn_06, btn_07);
		})
	})
})
...
btn_35.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		const modulePath1 = './modules/ChangerForOnDue.js';
		import(modulePath1).then((module) => {
			module.ChangerForOnDue(35, id1, btn_05, btn_06, btn_07);
		})
	})
})
...
btn_05.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		const modulePath1 = './modules/ChangerForOffDue.js';
		import(modulePath1).then((module) => {
			module.ChangerForOffDue(5, id1, btn_25, btn_30, btn_35);
		})
	})
})
...
btn_06.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		const modulePath1 = './modules/ChangerForOffDue.js';
		import(modulePath1).then((module) => {
			module.ChangerForOffDue(6, id1, btn_25, btn_30, btn_35);
		})
	})
})
...
btn_07.addEventListener('click', () => {
	...
	import(modulePath0).then((module) => {
		...
		const modulePath1 = './modules/ChangerForOffDue.js';
		import(modulePath1).then((module) => {
			module.ChangerForOffDue(7, id1, btn_25, btn_30, btn_35);
		})
	})
})
